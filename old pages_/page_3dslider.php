...
<head>
	...
	<link rel="shortcut icon" href="{{THEME_URL}}images-asff/asff_favicon.ico" alt="asff_favicon" width="16" height="16">
	<link rel="apple-touch-icon" href="{{THEME_URL}}images/favicons/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="72x72" href="{{THEME_URL}}images/favicons/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="114x114" href="{{THEME_URL}}images/favicons/apple-touch-icon-114x114.png">
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=489199584469051";
