...
$url_path = dirname(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));
...
if ($handle = opendir($images)) {
   ...
   closedir($handle);
	...
	foreach($files as $file) {
		$gal .=  '<li><a href="'.$images.$file.'" rel="prettyPhoto[gal]" class="hoverBorder"><img src="php_helpers/timthumb.php?src='.$url_path.'/'.$images.$file.'&amp;w='.$width.'&amp;h='.$height.'&amp;zc='.$crop.'" alt=""></a></li>';
	}
	$gal .=  '</ul>'; 
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							...
							echo make_gal('../../files/images/basketball/1200_500/','310','130','0');
							?>
